...
async function main() {
  ...
  const chefs = await db.insert(chefsTable).values([
    ...
    },
    {
      name: "Nadia Magdi",
      nameAr: "نادية مجدي",
      bio: "Nadia inherited her grandmother's mahshi recipes and has spent two decades making every leaf perfect.",
      bioAr: "نادية ورثت وصفات جدتها في المحاشي وأمضت عقدين في جعل كل ورقة مثالية.",
      imageUrl: "/mahshi.png",
    ...
    },
    {
      name: "Hanan Ibrahim",
      nameAr: "حنان إبراهيم",
      bio: "Hanan's slow-cooked molokhia with rabbit is a Sunday institution in Giza. Her lentil soup has won hearts across three generations.",
      bioAr: "ملوخية حنان المطبوخة ببطء مع الأرانب هي طقس يوم الأحد في الجيزة.",
      imageUrl: "/molokhia.png",
  ...
  const items = await db.insert(menuItemsTable).values([
    /* Rice & Grains */
    {
      ...
      price: 65,
      categoryId: c["rice-grains"].id, categoryName: "Rice & Grain Dishes", categoryNameAr: "أطباق الأرز والحبوب",
      imageUrl: "/koshari.png", dietary: ["vegan"],
      isAvailable: true, isFeatured: true,
      chefName: "Umm Hassan", chefNameAr: "أم حسن", rating: 4.9, prepTimeMinutes: 30,
    },
    {
      ...
      descriptionAr: "فول مدمس مطبوخ ببطء مع الثوم والليمون ورذاذ من زيت الزيتون البكر. وجبة الإفطار المصرية الأصيلة.",
      price: 45,
      categoryId: c["rice-grains"].id, categoryName: "Rice & Grain Dishes", categoryNameAr: "أطباق الأرز والحبوب",
      imageUrl: "/koshari.png", dietary: ["vegan"],
      isAvailable: true, isFeatured: false,
      chefName: "Umm Hassan", chefNameAr: "أم حسن", rating: 4.8, prepTimeMinutes: 45,
    },
    {
      name: "Macarona Béchamel", nameAr: "مكرونة بشاميل",
      description: "Layered pasta baked with spiced minced meat and a creamy golden béchamel — Egypt's beloved answer to lasagne.",
      descriptionAr: "مكرونة متعددة الطبقات مخبوزة مع لحم مفروم متبل وبشاميل كريمي ذهبي — اللازانيا بلمسة مصرية.",
      price: 110,
      categoryId: c["rice-grains"].id, categoryName: "Rice & Grain Dishes", categoryNameAr: "أطباق الأرز والحبوب",
      imageUrl: "/fatta.png", dietary: [],
      isAvailable: true, isFeatured: false,
      chefName: "Umm Hassan", chefNameAr: "أم حسن", rating: 4.7, prepTimeMinutes: 60,
    },
    /* Stuffed */
    {
      name: "Stuffed Vine Leaves", nameAr: "ورق عنب",
      ...
      price: 140,
      categoryId: c["stuffed"].id, categoryName: "Stuffed Dishes", categoryNameAr: "محاشي",
      imageUrl: "/mahshi.png", dietary: ["vegan"],
      isAvailable: true, isFeatured: true,
      chefName: "Nadia Magdi", chefNameAr: "نادية مجدي", rating: 4.9, prepTimeMinutes: 90,
    },
    {
      name: "Mixed Mahshi Platter", nameAr: "طبق محاشي مشكل",
      ...
      imageUrl: "/mahshi.png", dietary: ["vegan"],
      isAvailable: true, isFeatured: false,
      chefName: "Nadia Magdi", chefNameAr: "نادية مجدي", rating: 4.8, prepTimeMinutes: 100,
    },
    /* Meat */
    {
      name: "Lamb Fattah", nameAr: "فتة لحم ضأن",
      ...
      price: 235,
      categoryId: c["meat"].id, categoryName: "Meat Dishes", categoryNameAr: "أطباق اللحوم",
      imageUrl: "/fatta.png", dietary: [],
      isAvailable: true, isFeatured: true,
      chefName: "Samia Farouk", chefNameAr: "سامية فاروق", rating: 4.9, prepTimeMinutes: 120,
    },
    {
      name: "Grilled Kofta", nameAr: "كفتة مشوية",
      description: "Hand-rolled ground beef and lamb kofta seasoned with seven spices, charcoal-grilled to perfection.",
      descriptionAr: "كفتة لحم بقر وضأن مفرود باليد، متبلة بسبع بهارات ومشوية على الفحم بإتقان.",
      price: 155,
      categoryId: c["meat"].id, categoryName: "Meat Dishes", categoryNameAr: "أطباق اللحوم",
      imageUrl: "/kofta.png", dietary: [],
      isAvailable: true, isFeatured: true,
      chefName: "Samia Farouk", chefNameAr: "سامية فاروق", rating: 4.8, prepTimeMinutes: 40,
    },
    {
      ...
      imageUrl: "/kofta.png", dietary: [],
      isAvailable: true, isFeatured: false,
      chefName: "Samia Farouk", chefNameAr: "سامية فاروق", rating: 4.7, prepTimeMinutes: 35,
    },
    /* Soups & Stews */
    {
      name: "Molokhia with Chicken", nameAr: "ملوخية بالدجاج",
      description: "Silky jute leaves simmered in rich chicken broth with a sizzling garlic and coriander ta'leya.",
      descriptionAr: "أوراق ملوخية ناعمة في مرق دجاج غني مع تقلية ثوم وكسبرة مقلية.",
      price: 130,
      categoryId: c["soups-stews"].id, categoryName: "Soups & Stews", categoryNameAr: "شوربات وطواجن",
      imageUrl: "/molokhia.png", dietary: ["gluten-free"],
      isAvailable: true, isFeatured: false,
      chefName: "Hanan Ibrahim", chefNameAr: "حنان إبراهيم", rating: 4.8, prepTimeMinutes: 50,
    },
    {
      name: "Shorbet Ads", nameAr: "شوربة عدس",
      ...
      price: 75,
      categoryId: c["soups-stews"].id, categoryName: "Soups & Stews", categoryNameAr: "شوربات وطواجن",
      imageUrl: "/molokhia.png", dietary: ["vegan", "gluten-free"],
      isAvailable: true, isFeatured: false,
      chefName: "Hanan Ibrahim", chefNameAr: "حنان إبراهيم", rating: 4.7, prepTimeMinutes: 35,
    },
    {
      name: "Chicken Tagine", nameAr: "طاجن دجاج",
      ...
      imageUrl: "/molokhia.png", dietary: ["gluten-free"],
      isAvailable: true, isFeatured: false,
      chefName: "Hanan Ibrahim", chefNameAr: "حنان إبراهيم", rating: 4.8, prepTimeMinutes: 80,
    },
    /* Salads & Sides */
    {
      name: "Salata Baladi", nameAr: "سلطة بلدي",
      ...
      price: 55,
      categoryId: c["salads-sides"].id, categoryName: "Salads & Sides", categoryNameAr: "سلطات ومقبلات",
      imageUrl: "/kofta.png", dietary: ["vegan", "gluten-free"],
      isAvailable: true, isFeatured: false,
      chefName: "Umm Hassan", chefNameAr: "أم حسن", rating: 4.6, prepTimeMinutes: 10,
    },
    {
      name: "Tahini & Baba Ghanoush", nameAr: "طحينة وبابا غنوج",
      ...
      price: 70,
      categoryId: c["salads-sides"].id, categoryName: "Salads & Sides", categoryNameAr: "سلطات ومقبلات",
      imageUrl: "/kofta.png", dietary: ["vegan"],
      isAvailable: true, isFeatured: false,
      chefName: "Nadia Magdi", chefNameAr: "نادية مجدي", rating: 4.7, prepTimeMinutes: 15,
    },
    /* Desserts */
    {
      ...
      price: 85,
      categoryId: c["desserts"].id, categoryName: "Desserts", categoryNameAr: "حلويات",
      imageUrl: "/umm_ali.png", dietary: [],
      isAvailable: true, isFeatured: true,
      chefName: "Maha El-Sayed", chefNameAr: "مها السيد", rating: 4.9, prepTimeMinutes: 25,
    },
    {
      name: "Basbousa bil Ashta", nameAr: "بسبوسة بالقشطة",
      ...
      imageUrl: "/umm_ali.png", dietary: [],
      isAvailable: true, isFeatured: false,
      chefName: "Maha El-Sayed", chefNameAr: "مها السيد", rating: 4.8, prepTimeMinutes: 20,
    },
    {
      name: "Konafa bil Goz el-Hend", nameAr: "كنافة بجوز الهند",
      description: "Shredded filo pastry filled with sweet cream cheese and coconut, baked golden and drizzled with honey syrup.",
      descriptionAr: "عجينة كنافة محشوة بجبنة قشطة حلوة وجوز هند، مخبوزة حتى تصبح ذهبية وتُرش بالعسل.",
      price: 95,
      categoryId: c["desserts"].id, categoryName: "Desserts", categoryNameAr: "حلويات",
      imageUrl: "/umm_ali.png", dietary: [],
      isAvailable: true, isFeatured: false,
      chefName: "Maha El-Sayed", chefNameAr: "مها السيد", rating: 4.9, prepTimeMinutes: 30,
    },
  ]).returning();
  ...
  const testimonials = await db.insert(testimonialsTable).values([
    {
      ...
      type: "customer", rating: 5, avatarUrl: "/koshari.png",
    },
    {
      name: "Ahmed Kamal", nameAr: "أحمد كمال",
      ...
      type: "customer", rating: 5, avatarUrl: "/mahshi.png",
    },
    {
      name: "Dina Samir", nameAr: "دينا سمير",
      ...
      quoteAr: "غيّرت Get Mumm عشاءاتنا العائلية الأسبوعية. فتة العيد كانت بالضبط ما تخيلته لكن لم أستطع صنعه.",
      type: "customer", rating: 5, avatarUrl: "/fatta.png",
    },
    {
      name: "Omar Fathy", nameAr: "عمر فتحي",
      quote: "Our team of 40 orders lunch from Get Mumm three times a week. Always on time, always warm, and everyone looks forward to it.",
      quoteAr: "فريقنا المكون من 40 شخصاً يطلب الغداء من Get Mumm ثلاث مرات أسبوعياً. دائماً في الوقت المحدد والجميع يتطلع إليه.",
      type: "office", rating: 5, avatarUrl: "/kofta.png",
      company: "Nile Digital Agency", companyAr: "وكالة نايل ديجيتال",
      role: "Operations Manager", roleAr: "مدير العمليات",
    },
    {
      name: "Rania El-Desoky", nameAr: "رانيا الدسوقي",
      quote: "We've tried five catering companies. Get Mumm is the only one where people finish their plates — and ask for the chef's name.",
      quoteAr: "جربنا خمس شركات تقديم طعام. Get Mumm هي الوحيدة التي ينهي فيها الناس أطباقهم ويسألون عن اسم الطاهية.",
      type: "office", rating: 5, avatarUrl: "/molokhia.png",
      company: "Maadi Architecture Studio", companyAr: "استوديو معادي للعمارة",
      role: "Founder", roleAr: "المؤسسة",
    },
    {
      name: "Sara Mostafa", nameAr: "سارة مصطفى",
      ...
      type: "customer", rating: 5, avatarUrl: "/umm_ali.png",
    },
  ]).returning();
